  ...
  return (
    <div className="space-y-4 relative z-10 select-none">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-5 items-start">
        ...
        <div className="xl:col-span-6 bg-zinc-900 border border-zinc-800 rounded-2xl p-5 space-y-5 overflow-y-auto xl:h-[calc(100vh-185px)] scrollbar-thin">
        ...
        <div className="xl:col-span-6 space-y-4 overflow-y-auto xl:h-[calc(100vh-185px)] pr-1 scrollbar-thin">
